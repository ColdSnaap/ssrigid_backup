...
sg = {'sg_1': {'s1': [1, ['1'], ('x', 'y', 'z'), 1]},
      ...
      'sg_143':{'s1':[1, ['3', 'y', 'z'], (0.667, 0.333, 'z')],
                's2':[1, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's3':[1, ['3', 'y', 'z'], (0, 0, 'z')],
                's4':[3, ['1'], ('x', 'y', 'z')]},
      ...
      'sg_146':{'s1':[3, ['3', 'y', 'z'], (0, 0, 'z')],
                's2':[9, ['1'], ('x', 'y', 'z')],},
      
      'sg_147':{'s1':[3, ['-1'], (0.5, 0, 0.5)],
                's2':[3, ['-1'], (0.5, 0, 0)],
                's3':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's4':[2, ['3', 'y', 'z'], (0, 0, 'z')],
                's5':[1, ['-3', 'y', 'z'], (0, 0, 0.5)],
                's6':[1, ['-3', 'y', 'z'], (0, 0, 0)],
                's7':[6, ['1'], ('x', 'y', 'z')]},

      'sg_148':{'s1':[9, ['-1'], (0.5, 0, 0)],
                's2':[9, ['-1'], (0.5, 0, 0.5)],
                's3':[6, ['3', 'y', 'z'], (0, 0, 'z')],
                's4':[3, ['-3', 'y', 'z'], (0, 0, 0.5)],
                's5':[3, ['-3', 'y', 'z'], (0, 0, 0)],
      ...
      'sg_149':{'s1':[3, ['x', 'y', '2'], ('x', '-x', 0.5)],
                's2':[3, ['x', 'y', '2'], ('x', '-x', 0)],
                's3':[2, ['3', 'y', 'z'], (0.667, 0.333, 'z')],
                's4':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's5':[2, ['3', 'y', 'z'], (0, 0, 'z')],
                's6':[1, ['3', 'y', '2'], (0.667, 0.333, 0.5)],
                's7':[1, ['3', 'y', '2'], (0.667, 0.333, 0)],
                's8':[1, ['3', 'y', '2'], (0.333, 0.667, 0.5)],
                's9':[1, ['3', 'y', '2'], (0.333, 0.667, 0)],
                's10':[1, ['3', 'y', '2'], (0, 0, 0.5)],
                's11':[1, ['3', 'y', '2'], (0, 0, 0)],
                's12':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_150':{'s1':[3, ['x', '2', 'z'], ('x', 0, 0.5)],
                's2':[3, ['x', '2', 'z'], ('x', 0, 0)],
                's3':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's4':[2, ['3', 'y', 'z'], (0, 0, 'z')],
                's5':[1, ['3', '2', 'z'], (0, 0, 0.5)],
      ...
      'sg_151':{'s1':[3, ['x', 'y', '2'], ('x', '-x', 0.833)],
                's2':[3, ['x', 'y', '2'], ('x', '-x', 0.333)],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_152':{'s1':[3, ['x', '2', 'z'], ('x', 0, 0.833)],
                's2':[3, ['x', '2', 'z'], ('x', 0, 0.333)],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_153':{'s1':[3, ['x', 'y', '2'], ('x', '-x', 0.167)],
                's2':[3, ['x', 'y', '2'], ('x', '-x', 0.667)],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_154':{'s1':[3, ['x', '2', 'z'], ('x', 0, 0.167)],
                's2':[3, ['x', '2', 'z'], ('x', 0, 0.667)],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_156':{'s1':[3, ['x', 'm', 'z'], ('x', '-x', 'z')],
                's2':[1, ['3', 'm', 'z'], (0.667, 0.333, 'z')],
                's3':[1, ['3', 'm', 'z'], (0.333, 0.667, 'z')],
                's4':[1, ['3', 'm', 'z'], (0, 0, 'z')],
                's5':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_157':{'s1':[3, ['x', 'y', 'm'], ('x', 0, 'z')],
                's2':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's3':[1, ['3', 'y', 'm'], (0, 0, 'z')],
                's4':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_158':{'s1':[2, ['3', 'y', 'z'], (0.667, 0.333, 'z')],
                's2':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's3':[2, ['3', 'y', 'z'], (0, 0, 'z')],
                's4':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_159':{'s1':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's2':[2, ['3', 'y', 'z'], (0, 0, 'z')],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_163':{'s1':[6, ['x', 'y', '2'], ('x', '-x', 0.25)],
                's2':[6, ['-1'], (0.5, 0, 0)],
                's3':[4, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's4':[4, ['3', 'y', 'z'], (0, 0, 'z')],
                's5':[2, ['3', 'y', '2'], (0.667, 0.333, 0.25)],
                's6':[2, ['3', 'y', '2'], (0.333, 0.667, 0.25)],
                's7':[2, ['-3', 'y', 'z'], (0, 0, 0)],
                's8':[2, ['3', 'y', '2'], (0, 0, 0.25)],
                's9':[12, ['1'], ('x', 'y', 'z')]},

      'sg_164':{'s1':[6, ['x', 'm', 'z'], ('x', '-x', 'z')],
                's2':[6, ['x', '2', 'z'], ('x', 0, 0.5)],
                's3':[6, ['x', '2', 'z'], ('x', 0, 0)],
                's4':[3, ['x', '2/m', 'z'], (0.5, 0, 0.5)],
                's5':[3, ['x', '2/m', 'z'], (0.5, 0, 0)],
                's6':[2, ['3', 'm', 'z'], (0.333, 0.667, 'z')],
                's7':[2, ['3', 'm', 'z'], (0, 0, 'z')],
                's8':[1, ['-3', 'm', 'z'], (0, 0, 0.5)],
                's9':[1, ['-3', 'm', 'z'], (0, 0, 0)],
                's10':[12, ['1'], ('x', 'y', 'z')]},

      'sg_165':{'s1':[6, ['x', '2', 'z'], ('x', 0, 0.25)],
                's2':[6, ['-1'], (0.25, 0, 0)],
                's3':[4, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's4':[4, ['3', 'y', 'z'], (0, 0, 'z')],
                's5':[2, ['-3', 'y', 'z'], (0, 0, 0)],
      ...
      'sg_168':{'s1':[3, ['2', 'y', 'z'], (0.5, 0, 'z')],
                's2':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's3':[1, ['6', 'y', 'z'], (0, 0, 'z')],
                's4':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_171':{'s1':[3, ['2', 'y', 'z'], (0.5, 0.5, 'z')],
                's2':[3, ['2', 'y', 'z'], (0, 0, 'z')],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_172':{'s1':[3, ['2', 'y', 'z'], (0.5, 0.5, 'z')],
                's2':[3, ['2', 'y', 'z'], (0, 0, 'z')],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_173':{'s1':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's2':[2, ['3', 'y', 'z'], (0, 0, 'z')],
                's3':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_174':{'s1':[3, ['m', 'y', 'z'], ('x', 'y', 0.5)],
                's2':[3, ['m', 'y', 'z'], ('x', 'y', 0)],
                's3':[2, ['3', 'y', 'z'], (0.667, 0.333, 'z')],
                's4':[2, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's5':[2, ['3', 'y', 'z'], (0, 0, 'z')],
                's6':[1, ['-6', 'y', 'z'], (0.667, 0.333, 0.5)],
                's7':[1, ['-6', 'y', 'z'], (0.667, 0.333, 0)],
                's8':[1, ['-6', 'y', 'z'], (0.333, 0.667, 0.5)],
                's9':[1, ['-6', 'y', 'z'], (0.333, 0.667, 0)],
                's10':[1, ['-6', 'y', 'z'], (0, 0, 0.5)],
                's11':[1, ['-6', 'y', 'z'], (0, 0, 0)],
                's12':[6, ['1'], ('x', 'y', 'z')]},
      
      'sg_176':{'s1':[6, ['m', 'y', 'z'], ('x', 'y', 0.25)],
                's2':[6, ['-1'], (0.5, 0, 0)],
                's3':[4, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's4':[4, ['3', 'y', 'z'], (0, 0, 'z')],
                's5':[2, ['-6', 'y', 'z'], (0.667, 0.333, 0.25)],
                's6':[2, ['-6', 'y', 'z'], (0.333, 0.667, 0.25)],
                's7':[2, ['-3', 'y', 'z'], (0, 0, 0)],
                's8':[2, ['-3', 'y', 'z'], (0, 0, 0.25)],
                's9':[12, ['1'], ('x', 'y', 'z')]},

      'sg_182':{'s1':[6, ['x', 'y', '2'], ('x', '2x', 0.25)],
                's2':[6, ['x', '2', 'z'], ('x', 0, 0.25)],
                's3':[4, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's4':[4, ['3', 'y', 'z'], (0, 0, 'z')],
                's5':[2, ['3', 'y', '2'], (0.333, 0.667, 0.75)],
                's6':[2, ['3', 'y', '2'], (0.333, 0.667, 0.25)],
                's7':[2, ['3', '2', 'z'], (0, 0, 0)],
                's8':[12, ['1'], ('x', 'y', 'z')]},

      'sg_183':{'s1':[6, ['x', 'm', 'z'], ('x', '-x', 'z')],
                's2':[6, ['x', 'y', 'm'], ('x', 0, 'z')],
                's3':[3, ['2', 'm', 'm'], (0.5, 0, 'z')],
                's4':[2, ['3', 'm', 'z'], (0.333, 0.667, 'z')],
                's5':[1, ['6', 'm', 'm'], (0, 0, 'z')],
                's6':[12, ['1'], ('x', 'y', 'z')]},

      'sg_186':{'s1':[6, ['x', 'm', 'z'], ('x', '-x', 'z')],
                's2':[2, ['3', 'm', 'z'], (0.333, 0.667, 'z')],
                's3':[2, ['3', 'm', 'z'], (0, 0, 'z')],
                's4':[12, ['1'], ('x', 'y', 'z')]},

      'sg_187':{'s1':[6, ['x', 'm', 'z'], ('x', '-x', 'z')],
                's2':[6, ['m', 'y', 'z'], ('x', 'y', 0.5)],
                's3':[6, ['m', 'y', 'z'], ('x', 'y', 0)],
                's4':[3, ['m', 'm', '2'], ('x', '-x', 0.5)],
                's5':[3, ['m', 'm', '2'], ('x', '-x', 0)],
                's6':[2, ['3', 'm', 'z'], (0.667, 0.333, 'z')],
                's7':[2, ['3', 'm', 'z'], (0.333, 0.667, 'z')],
                's8':[2, ['3', 'm', 'z'], (0, 0, 'z')],
                's9':[1, ['-6', 'm', '2'], (0.667, 0.333, 0.5)],
                's10':[1, ['-6', 'm', '2'], (0.667, 0.333, 0)],
                's11':[1, ['-6', 'm', '2'], (0.333, 0.667, 0.5)],
                's12':[1, ['-6', 'm', '2'], (0.333, 0.667, 0)],
                's13':[1, ['-6', 'm', '2'], (0, 0, 0.5)],
                's14':[1, ['-6', 'm', '2'], (0, 0, 0)],
                's15':[12, ['1'], ('x', 'y', 'z')]},
      
      'sg_190':{'s1':[6, ['m', 'y', 'z'], ('x', 'y', 0.25)],
                's2':[6, ['x', '2', 'z'], ('x', 0, 0.25)],
                's3':[4, ['3', 'y', 'z'], (0.333, 0.667, 'z')],
                's4':[4, ['3', 'y', 'z'], (0, 0, 'z')],
                's5':[2, ['-6', 'y', 'z'], (0.667, 0.333, 0.25)],
      ...
      'sg_194':{'s1':[12, ['x', 'm', 'z'], ('x', '2x', 'z')],
                's2':[12, ['m', 'y', 'z'], ('x', 'y', 0.25)],
                's3':[12, ['x', '2', 'z'], ('x', 0, 0)],
                's4':[6, ['m', 'm', '2'], ('x', '2x', 0.25)],
                's5':[6, ['x', '2/m', 'z'], (0.5, 0, 0)],
                's6':[4, ['3', 'm', 'z'], (0.333, 0.667, 'z')],
                's7':[4, ['3', 'm', 'z'], (0, 0, 'z')],
                's8':[2, ['-6', 'm', '2'], (0.333, 0.667, 0.75)],
                's9':[2, ['-6', 'm', '2'], (0.333, 0.667, 0.25)],
                's10':[2, ['-6', 'm', '2'], (0, 0, 0.25)],
                's11':[2, ['-6', 'm', '2'], (0, 0, 0)],
                's12':[24, ['1'], ('x', 'y', 'z')]}
